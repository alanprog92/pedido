...
public class Cliente {
	...
	public String toString() {
		return "Cliente [id=" + id + ", nome=" + nome + ", tipopessoa=" + tipopessoa + ", cpf_cnpj=" + cpf_cnpj
				+ ", fone=" + fone + ", endereco=" + endereco + ", numero=" + numero + ", bairro=" + bairro
				+ ", cidade=" + cidade + ", uf=" + uf + ", cep=" + cep + ", codigoERP=" + codigoERP + ", vendedor="
				+ vendedor + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + "]";
	}
